namespace ClsOutDocDeliveryCtrl
{
    partial class frm_StartUp
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btn_Start.Location = new System.Drawing.Point(277, 488);
            ...
            this.lbl_info.Text = "# This application program is designed to aid the project Owners, or their repres" +
    "entative (The Consultants/PMO), manage the process of closeout documents\' delive" +
    "ry to the Owner.";
            // 
            // label1
            // 
            ...
            this.label1.Text = "# This Application is designed for construction projects, specially commercial pr" +
    "ojects.";
            // 
            // label2
            // 
            ...
            this.label3.Text = "# We strongly recommend to keep a retention from the contractor\'s payment for the" +
    " delivery of closeout documents only, other than the traditional retention. ";
            // 
            // label4
            // 
            ...
            this.label4.Text = "# This retention is to be set between 3-5% of the total contract price to form a " +
    "real motivation to the contractor in the documents delivery process, otherwise t" +
    "he traditional retention can be used.";
            // 
            // label5
            // 
