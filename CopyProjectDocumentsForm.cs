...
namespace CopyProjectDocumentsForm
{
    ...
    public partial class CopyProjectDocumentsForm : Form
    {
        ...
        public CopyProjectDocumentsForm(Project project)
        {
            _project = project;
            InitializeComponent();
        ...
        private void startView()
        {
            ...
            gridView_ProjectDocs.Columns["RcmdDeadlineBeforeHandover"].Visible = true;
            gridView_ProjectDocs.Columns["RcmdDeadlineAfterHandover"].Visible = true;
        ...
        private void btn_basicInfoNext_Click(object sender, EventArgs e)
        {
            ...
            gridView_ProjectDocs.Columns["Name"].Visible = true;
            gridView_ProjectDocs.Columns["ActFirstCTRSubmitDeadline"].Visible = true;
            gridView_ProjectDocs.Columns["ActFirstCTRSubmitDeliveryDate"].Visible = true;
            gridView_ProjectDocs.Columns["FirstCTRSubmitStatus"].Visible = true;
            gridView_ProjectDocs.Columns["ExpFirstConsultRspDate"].Visible = true;
            gridView_ProjectDocs.Columns["ActFirstConsultRspDate"].Visible = true;
            firstStatusCol.Visible = true;
            gridView_ProjectDocs.Columns["ConsultFirstRspStatus"].Visible = true;
        }
    }
}