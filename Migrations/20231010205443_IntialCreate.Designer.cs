...
namespace ClsOutDocDeliveryCtrl.Migrations
{
    ...
    [Migration("20231010205443_IntialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocumentProject", b =>
                {
                    ...
                    b.HasKey("DocumentsDocumentId", "ProjectsProjectId");

                    b.HasIndex("ProjectsProjectId");

                    b.ToTable("DocumentProject");
                });

            modelBuilder.Entity("DocumentProject", b =>
                {
                    b.HasOne("ClsOutDocDeliveryCtrl.Entities.Document", null)
                        .WithMany()
                        .HasForeignKey("DocumentsDocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClsOutDocDeliveryCtrl.Entities.Project", null)
                        .WithMany()
